...
- [ ] 4. Integrate attach and re-parent drag-end behavior without parent containment expansion
...
- [ ] 5. Implement managed mind-map child drag threshold, snap-back, detach, and parent drag invariants
