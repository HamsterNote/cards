...
export function resolveCardContentBlocks(
  cardId: string,
  content: string,
  contentBlocks: readonly CardContentBlock[] | undefined
): readonly CardContentBlock[] {
...
function blockPlainText(block: CardContentBlock): string | undefined {
...
export function extractPlainTextFromBlocks(
  blocks: readonly CardContentBlock[]
): string {
  return blocks
    .map(blockPlainText)
